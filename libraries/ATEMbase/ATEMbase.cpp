/*
Copyright 2012-2014 Kasper Skarhoj, SKAARHOJ K/S, kasper@skaarhoj.com
...
//	if (_serialOutput) 	{
	...
	_packetBuffer[9] = 0x51;	// This seems to be what the client should send upon first request. 
...
//Serial.print("Header Bitmask : ");
//Serial.println(headerBitmask);
